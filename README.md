...
[JSHint](http://jshint.com/) and can be used to customise the standards and
rules which the JavaScript source code must adhere to.
...
### `lint`
A wrapper method that runs both the `jshint` and `jscs` tasks.
